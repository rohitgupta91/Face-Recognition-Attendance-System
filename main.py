...
# This part is image labels setting start 
        ...
        # lbl.place(x=0,y=60,width=200,height=50)
        # time()
        ...
        lbl = Label(self.root, font = ('calibri', 40, 'bold'),
        background = 'white',
        foreground = 'black')
        ...
        # Photo   button 6
        pho_img_btn=Image.open(r"Images_GUI\f_det.jpg")
...
# ==================Functions Buttons=====================
    ...
    def Close(self):
        self.Close=tkinter.messagebox.askyesno("Face Recognition","Are you sure exit ths project",parent=self.root)
        if self.Close>0:
            self. root.destroy()
        else:
            return
